# A class for image and mask manipulation.
...
class Loader:
    ...
    path_string = "WIDER_images_256/*/images/*"
    image_directories = glob.glob(path_string)
    image_files = glob.glob(path_string+"/*.jpg")
    annotation_train_directory = "WIDER_images_256/WIDER_annotations/WIDER_train"
    annotation_val_directory = "WIDER_images_256/WIDER_annotations/WIDER_val"
    ...
    def make_masks(self):
        ...
        directory = self.annotation_val_directory
        ...
        for file in filepaths:  # for each .xml annotation file . . .
            ...
            file_name = re.sub(re.compile(r"\./"), "WIDER_images_256/", file_name)
